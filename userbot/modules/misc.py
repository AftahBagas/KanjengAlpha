...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Alpha....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Alpha Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting Alpha...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Alpha Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Alpha Repo](https://github.com/Aftahbagas/Alpha/blob/Alpha/README.md)"
...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Harap Balas Di Gambar Alpha`")
        return
